...
//Adding bookmark with implentation of other functions
function displayBookmark(indexOfWebsite) {
  ...
  var newBookmark = `
              <tr>
                ...
                <td>
                  <button class="btn btn-dark btn-visit" data-index="${indexOfWebsite}">
                    <i class="fa-solid fa-eye pe-2"></i>Visit
                  </button>
                </td>
                <td>
                  <button class="btn btn-dark btn-delete pe-2" data-index="${indexOfWebsite}">
